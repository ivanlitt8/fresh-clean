...
export const handler: Handler = async (event) => {
    console.log('Netlify Function /contact called');
    ...
    try {
        ...
        if (!contact) {
            ...
            return {
                statusCode: 400,
                headers,
                body: JSON.stringify({ error: 'No contact data provided' }),
            };
        }
        ...
        try {
            ...
            return {
                statusCode: 200,
                headers,
                body: JSON.stringify({ success: true, message: 'Contact emails sent successfully' }),
            };
        } catch (emailError) {
            ...
            return {
                statusCode: 500,
                headers,
                body: JSON.stringify({ error: 'Failed to send contact emails' }),
            };
        }
    } catch (error) {
